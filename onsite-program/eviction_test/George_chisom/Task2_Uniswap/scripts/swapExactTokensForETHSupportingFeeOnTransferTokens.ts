...
async function main() {
  ...
  console.log("Swapping USDC for ETH with fee support...");
  const swapTx = await Router.connect(impersonatedSigner).swapExactTokensForETHSupportingFeeOnTransferTokens(
    amountIn,
    amountOutMin,
    path,
